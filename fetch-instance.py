...
# function to fetch the running Ec2 in AWS in perticular region
...
def list_running_EC2():
    ...
    # Fetch all the details of the running instance in aws  
...
# Define the Function to delete the one of running instace [ will ask you the name of running instace which you wan to delete. ]
...
def delete_instance_by_name(Ec2_name):
    ...
    if response['Reservations']:
        ...
        print(f"Your instance found with  this name: '{Ec2_name}', and your Instance ID is : {instance_id}")

        # Ask for deletion confirmation
        delete = input(f"You enter this instance name '{Ec2_name}' with ID {instance_id} which you want to delete ? (y/n): ")
        ...
        print(f"Ohh, No instance found with name '{Ec2_name}'.")
